...
public class App   {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("You wake up in the middle of the night, startled by a noise. After looking around for the source of the noise," + 
        ...
        if (choice.equals("1")) {
            ...
            System.out.println("With Cayla still asleep next to you, you decide to get up and see where the light is coming from. " +
